...
interface TagCreatorProps {
  subaccountId: string;
  getSelectedTags: (tags: TagPrisma[]) => void;
  defaultTags?: TagPrisma[];
}
...
const TagCreator = ({
  ...
  const [selectedTags, setSelectedTags] = useState<TagPrisma[]>(
    defaultTags || []
  );
  const [tags, setTags] = useState<TagPrisma[]>([]);
  ...
  const handleAddSelection = (tag: TagPrisma) => {
